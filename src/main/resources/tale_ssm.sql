...
CREATE TABLE t_metas (mid INTEGER PRIMARY KEY auto_increment UNIQUE NOT NULL, name VARCHAR (200) NOT NULL, slug VARCHAR (200), mtype VARCHAR (32) NOT NULL, description VARCHAR (255), sort INTEGER (4) DEFAULT 0, parent INTEGER (10) DEFAULT 0);
INSERT INTO t_metas (mid, name, slug, mtype, description, sort, parent) VALUES (1, '默认分类', NULL, 'category', NULL, 0, 0);
select * from t_metas;
