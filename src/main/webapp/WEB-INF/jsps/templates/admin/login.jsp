...
<head>
    ...
    <script src="<%=p %>/static/admin/plugins/jquery/3.2.1/jquery-3.2.1.js"></script>
    <style type="text/css">
        body,html {
            background: url("<%= p %>/static/admin/images/bg/4.png") no-repeat;
...
<div style="margin: 0 auto; padding-bottom: 0%; padding-top: 7.5%; width: 380px;">
    <div class="panel panel-color panel-danger panel-pages panel-shadow">
        ...
        <div class="panel-body">
            <form class="form-horizontal m-t-20" method="post" id="loginForm" action="<%=p %>/admin/login.action">
                ...
                <div class="form-group text-center m-t-40">
                    <div class="col-xs-12">
                        <button class="btn btn-danger btn-lg btn-rounded btn-block w-lg waves-effect waves-light" style="box-shadow: 0px 0px 4px #868282;" 
                        type="submit" >登&nbsp;录
                        </button>
                    </div>
                </div>
